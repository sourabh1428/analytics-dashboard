...
const THEMES: Record<string, SectionTheme> = {
  ...
  easibill: { icon: "🚀", iconBg: "bg-emerald-50", accent: "border-emerald-500", badge: "bg-emerald-50 text-emerald-700" },
  solv:     { icon: "🚀", iconBg: "bg-emerald-50", accent: "border-emerald-500", badge: "bg-emerald-50 text-emerald-700" },
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 pb-10 sm:px-12">
          <div className="mx-auto max-w-4xl">
            <div className="flex flex-wrap items-center gap-2">
              <span className="rounded-full bg-emerald-500 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-white">
                {page.keyword}
              </span>
      ...
      <div className="border-b border-zinc-200 bg-white shadow-sm">
        <div className="mx-auto grid max-w-4xl grid-cols-2 sm:grid-cols-4">
          {[
            ...
            { stat: "0%",   sub: "GST on essential drugs",   color: "text-emerald-600" },
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:gap-10">
          ...
          <aside className="w-full space-y-5 lg:w-64 lg:shrink-0">
            ...
            {/* CTA card */}
            <div className="sticky top-6 rounded-2xl bg-gradient-to-br from-emerald-600 to-emerald-800 p-6 text-white shadow-xl">
              ...
              <Link
                ...
                className="mt-5 flex items-center justify-center rounded-xl bg-white px-4 py-3 text-sm font-bold text-emerald-700 shadow transition hover:bg-emerald-50"
              >
                Start free trial →
              </Link>
              <p className="mt-2 text-center text-xs text-emerald-300">No credit card required</p>
            </div>

            {/* Jump-to-FAQ */}
            <a
              href="#faq"
              className="flex items-center gap-3 rounded-xl border border-zinc-200 bg-white px-4 py-4 text-sm font-semibold text-zinc-700 shadow-sm transition hover:border-emerald-300 hover:text-emerald-700"
            >
