...
export const metadata: Metadata = {
  ...
  description:
    "Read real reviews from pharmacy owners who use EasiBill. See how Indian medical stores improved patient retention and recovered revenue with WhatsApp refill reminders.",
  alternates: {
