    ...
    <div className="bg-white">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-2xl overflow-hidden">
              <div className="bg-slate-900 px-5 py-4">
                ...
                <div className="mt-4 grid grid-cols-2 gap-2">
                  {[
                    ...
                    { label: "Follow-ups recovered", val: "347", color: "text-green-300" },
                    { label: "Inactive customers", val: "89", color: "text-red-300" },
              ...
              <div className="p-5">
                <p className="text-xs font-medium text-gray-500 mb-3">Follow-up rate — last 7 months</p>
                ...
                <div className="mt-4 space-y-2">
                  <p className="text-xs font-medium text-gray-500">Inactive customers (90+ days)</p>
                  {[
                    ...
                    <div key={p.name} className="flex items-center justify-between bg-red-50 rounded-lg px-3 py-2">
                      <div>
                        ...
                        <p className="text-[10px] text-gray-400">{p.item}</p>
                      </div>
      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-500 text-center mb-12 max-w-xl mx-auto">Most business owners track only daily revenue. EasiBill shows you the numbers that predict future revenue.</p>
