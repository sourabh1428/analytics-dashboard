    ...
    <div className="bg-white">
              ...
              <div className="bg-gray-900 rounded-3xl p-6 shadow-2xl max-w-sm mx-auto">
                <div className="flex items-center gap-3 mb-4 pb-4 border-b border-white/10">
                  ...
                  <div>
                    ...
                    <p className="text-white/40 text-xs">Follow-up Reminders</p>
                  </div>
                </div>
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 py-3 border-b border-white/5 last:border-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-white/40 text-[10px] truncate">{p.item}</p>
                    </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 text-center mb-16">How follow-up reminders work</h2>
      ...
      <section className="py-20 px-6 bg-slate-900 text-center">
        <h2 className="text-3xl font-bold text-white mb-4">Ready to stop losing follow-ups?</h2>
        <p className="text-white/60 mb-8 max-w-md mx-auto">Set up your first follow-up reminder in under 5 minutes. Free to start.</p>
