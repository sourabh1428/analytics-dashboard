...
export const metadata: Metadata = {
  title: "Patient Records – Medicine, Interval & Contact Per Patient | EasiBill",
  description: "Store every patient's medicine, refill interval, and WhatsApp number in one place. EasiBill makes patient records simple for independent pharmacies.",
  alternates: { canonical: "https://easibill.com/features/patient-records" },
};

const patients = [
  { name: "Anjali Mehta", age: 58, drug: "Metformin 500mg", interval: "30 days", phone: "+91 98201 xxxxx", lastRefill: "Jun 1", nextDue: "Jul 1", status: "on-track" },
  { name: "Ravi Shankar", age: 65, drug: "Amlodipine 5mg", interval: "30 days", phone: "+91 97303 xxxxx", lastRefill: "May 18", nextDue: "Jun 17", status: "overdue" },
  { name: "Deepa Iyer", age: 44, drug: "Levothyroxine 50mcg", interval: "90 days", phone: "+91 96112 xxxxx", lastRefill: "Apr 5", nextDue: "Jul 4", status: "on-track" },
  { name: "Suresh Pillai", age: 71, drug: "Atorvastatin 20mg", interval: "30 days", phone: "+91 99820 xxxxx", lastRefill: "Jun 12", nextDue: "Jul 12", status: "upcoming" },
];
    ...
    <div className="bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight mb-6">
                Every patient's medicine history,{" "}
                <span className="text-blue-600">always at your fingertips</span>
              </h1>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Stop searching through paper registers. EasiBill stores each patient's medicines, dosages, refill intervals, and WhatsApp number — searchable in seconds.
              </p>
                  ...
                  <div key={p.name} className="rounded-xl border border-gray-100 p-4 hover:border-blue-100 hover:bg-blue-50/30 transition-colors cursor-pointer">
                    ...
                    <div className="mt-3 grid grid-cols-3 gap-2 text-[10px]">
                      <div className="bg-gray-50 rounded-lg px-2 py-1.5">
                        <p className="text-gray-400">Medicine</p>
                        <p className="font-medium text-slate-700 truncate">{p.drug}</p>
                      </div>
                      <div className="bg-gray-50 rounded-lg px-2 py-1.5">
      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-bold text-slate-900 text-center mb-12">What's stored for each patient</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: User, title: "Name & contact", body: "Full name and WhatsApp number — used for reminders and billing." },
              { icon: Pill, title: "Medicine & dosage", body: "Exact drug name and strength. Multiple medicines per patient." },
              { icon: Calendar, title: "Refill interval", body: "Per-patient interval drives the reminder schedule automatically." },
              { icon: FileText, title: "Purchase history", body: "Every dispensing event logged with date and quantity." },
              { icon: Search, title: "Instant search", body: "Find any patient by name or phone number in under a second." },
              { icon: Shield, title: "Data stays private", body: "Patient data is encrypted and never shared with third parties." },
      ...
      <section className="py-20 px-6 bg-slate-900 text-center">
        ...
        <p className="text-white/60 mb-8 max-w-md mx-auto">Import your existing patient list or start fresh — set up takes under 5 minutes.</p>
