...
export const metadata: Metadata = {
  title: "Privacy Policy – Ferbz",
  description: "Learn how Ferbz collects, uses, and protects your business and customer data, including WhatsApp numbers, purchase history, and billing records.",
  alternates: { canonical: "https://ferbz.com/privacy" },
};
...
const sections = [
  ...
  },
  {
    ...
    body: `We use collected data to operate and improve Ferbz: sending WhatsApp follow-up reminders on your behalf, generating daily queues, producing retention analytics, and providing customer support. We do not sell or rent your data or your customers' data to any third party.`,
  },
  {
    heading: "3. WhatsApp Integration",
    body: `Ferbz connects to WhatsApp Business API to deliver reminder and broadcast messages. Message content is composed by our system from your customer records and templates you approve. Messages are routed through Meta's infrastructure and are subject to Meta's own privacy practices. We store message-delivery status (sent, delivered, read) for analytics purposes only.`,
  },
  {
    heading: "4. Customer Data",
    body: `Customer records stored in Ferbz are treated as sensitive personal data. We encrypt all customer records at rest (AES-256) and in transit (TLS 1.3). Access is restricted to authenticated users with permissions scoped to your business account. We do not use customer data to train AI models or for any purpose beyond operating Ferbz for your account.`,
  },
  {
  ...
  },
  {
    ...
    body: `Ferbz uses the following third-party processors: Google Cloud (hosting and storage), Stripe (payment processing), Meta WhatsApp Business API (message delivery), and Vercel (web hosting). Each processor has its own data processing agreement and privacy standards.`,
  },
  {
    heading: "8. Your Rights",
    body: `Depending on your jurisdiction you may have rights to access, correct, export, or delete your personal data. To exercise any of these rights contact us at support@ferbz.com. We respond within 30 days.`,
  },
  {
    heading: "9. Security",
  ...
  },
  {
    ...
    body: `We may update this policy as our product evolves. Material changes will be notified via email to the account owner at least 14 days before taking effect. Continued use of Ferbz after that date constitutes acceptance.`,
  },
  {
    heading: "11. Contact",
    body: `Questions about this policy? Email support@ferbz.com or call +91 8839143395.`,
  },
];
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-20">
      ...
      <p className="mt-6 leading-7 text-mutedink">
        Ferbz ("we", "our", "us") is committed to protecting the privacy of local business owners and their customers. This policy explains what data we collect, how we use it, and the rights you have over it.
      </p>
