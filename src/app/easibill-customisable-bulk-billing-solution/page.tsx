...
export const metadata: Metadata = {
  ...
  description:
    "EasiBill's customisable bulk billing solution helps Indian pharmacies generate GST invoices, manage bulk orders, and send bills on WhatsApp — all in under 5 minutes of setup.",
  alternates: {
